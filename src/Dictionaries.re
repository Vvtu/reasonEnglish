...
let dictionary1 = [
  ...
  {rus: {js||js}, eng: "Like projects, Sprints are used to accomplish something."},
  {rus: {js||js}, eng: "Sprints enable predictability by ensuring inspection and adaption of progress toward a Sprint Goal at least every calendar month."},
  {rus: {js||js}, eng: "Only the Product Owner has the authority to cancel the Sprint, although he or she may do so under influence of the stakeholders, the Development Team, or the Scrum Master."},
  {rus: {js||js}, eng: "Sprint cancellations consume resources, since everyone regroups in another Sprint Planning to start another Sprint."},
  {rus: {js||js}, eng: "The work to be performed in the Sprint is planned at the Sprint Planning. This plan is crated by the collaboration work of the entire Scrum Team."},
  {rus: {js||js}, eng: "Sprint Planning answers the following: What can be delivered in the Increment resulting from the upcoming Sprint."},
  {rus: {js||js}, eng: ""},
  {rus: {js||js}, eng: ""},
  {rus: {js||js}, eng: ""},
  {rus: {js||js}, eng: ""},
