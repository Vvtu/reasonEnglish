...
let dictionary1 = [
  ...
  {rus: {js||js}, eng: "Scrum's artifacts represent work or value to provide transparency and opportunities for inspection and adaption."},
  {rus: {js||js}, eng: "Artifacts defined by Scrum are specifically designed to maximize transparency of key information so that everybody has the same understanding of the artifact."},
  {rus: {js||js}, eng: "The Product Backlog is an ordered list of everything that is known to be needed in the product."},
  {rus: {js||js}, eng: "The Product Backlog is the single source of requirements for any changes to be made to the product."},
  {rus: {js||js}, eng: "The Product Backlog lists all the features, functions, requirements, enhancements, and fixes that constitute the changes to be made to the product in future releases."},
  {rus: {js||js}, eng: ""},
  {rus: {js||js}, eng: ""},
  {rus: {js||js}, eng: ""},
];
