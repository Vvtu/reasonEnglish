...
type wordPair = {
 ...
 type dictSet = {
  dictionary1: list(wordPair),
  oldDictionary1: list(wordPair),
  dictionary2: list(wordPair),
  oldDictionary2: list(wordPair)
};



 let dictionary1: list(wordPair) = [
  ...
  let oldDictionary1: list(wordPair) = [
  ...
  let oldDictionary2: list(wordPair) = [
    {
      rus:
